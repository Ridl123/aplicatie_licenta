        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Interventions_Calls_CallId",
                        column: x => x.CallId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InterventionUnits", x => new { x.InterventionId, x.UnitId });
                    table.ForeignKey(
                        name: "FK_InterventionUnits_Interventions_InterventionId",
                        column: x => x.InterventionId,
                        principalTable: "Interventions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InterventionUnits_Units_UnitId",
                        column: x => x.UnitId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Interventions_CallId",
                table: "Interventions",
                column: "CallId");

            migrationBuilder.CreateIndex(
                name: "IX_InterventionUnits_UnitId",
                table: "InterventionUnits",
                column: "UnitId");
        }
