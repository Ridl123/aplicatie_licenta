...
import { Activity, Flame, ShieldAlert, HelpCircle } from "lucide-react";
...
// Funcție pentru generarea iconițelor Lucide personalizate
const createLucideIcon = (type: string) => {
  let IconComponent;
  let color;

  // Adăugăm .toUpperCase() pentru a prinde și "Fire" și "FIRE" (pt ca am avut problema cu ala pus initial)
  ...
  // Convertim iconița Lucide în HTML static pentru Leaflet
...
export default function InterventionsPage() {
  ...
  useEffect(() => {
    fetch(API_URL)
      ...
      .catch((err) => console.error("Eroare încărcare markeri:", err));
  }, []);
      ...
      >
        ...
        {calls.map((call) => (
          <Marker
            ...
            icon={createLucideIcon(call.emergencyType)}
          >
            <Popup>
              <div
                style={{
              ...
              >
                <div
                  style={{
                    ...
                    paddingBottom: "2px",
                    color:
                      call.emergencyType === "MEDICAL"
                        ? "#ef4444"
                        : call.emergencyType === "FIRE"
                          ? "#f97316"
                          : "#3b82f6",
                  }}
                >
                ...
                <div style={{ fontSize: "13px" }}>
                  <strong>Tel:</strong> {call.callerNumber}
                </div>
                <div
                  style={{
                    fontSize: "12px",
